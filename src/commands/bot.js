...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .setDescription('Community bot for rules verification, onboarding roles, leveling, guided gallery and video submissions, events, spotlight voting, tickets, and weekly community touches.')
